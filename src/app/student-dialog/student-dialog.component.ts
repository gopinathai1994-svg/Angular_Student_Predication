      ...
      <header class="dialog-header">
        <div class="header-title">
          <span class="mode-badge" [ngClass]="data.mode">
            <mat-icon>{{ data.mode === 'view' ? 'visibility' : data.mode === 'edit' ? 'edit' : 'person_add' }}</mat-icon>
            {{ data.mode | uppercase }} MODE
          </span>
          <h2>{{ data.mode === 'view' ? 'Student Profile Overview' : data.mode === 'edit' ? 'Edit Profile Details' : 'Create New Profile' }}</h2>
        </div>
        ...
        <form [formGroup]="studentForm" class="form-grid">
          ...
          <div class="form-group">
            ...
            <mat-form-field appearance="outline" class="full-width">
              ...
              <mat-error *ngIf="studentForm.get('Roll_No')?.hasError('required')">Roll No is required</mat-error>
            </mat-form-field>
          </div>
          ...
          <div class="form-group">
            ...
            <mat-form-field appearance="outline" class="full-width">
              ...
              <mat-error *ngIf="studentForm.get('Section')?.hasError('required')">Section is required</mat-error>
            </mat-form-field>
          </div>
          ...
          <div class="form-group">
            ...
            <mat-form-field appearance="outline" class="full-width">
              ...
              <mat-error *ngIf="studentForm.get('Attendance')?.invalid">Attendance score (0-100) required</mat-error>
            </mat-form-field>
          </div>
          ...
          <div class="form-group">
            ...
            <mat-form-field appearance="outline" class="full-width">
              ...
              <mat-error *ngIf="studentForm.get('Monthly_Mark')?.invalid">Valid mark (0-100) required</mat-error>
            </mat-form-field>
          </div>
          ...
          <div class="form-group">
            ...
            <mat-form-field appearance="outline" class="full-width">
              ...
              <mat-error *ngIf="studentForm.get('Parent_Name')?.hasError('required')">Parent Name is required</mat-error>
            </mat-form-field>
          </div>
          ...
          <div class="form-group span-2">
            ...
            <mat-form-field appearance="outline" class="full-width">
              <input matInput type="email" formControlName="Parent_Email" placeholder="parent@gmail.com" />
              <mat-error *ngIf="studentForm.get('Parent_Email')?.hasError('email')">Enter a valid email address</mat-error>
            </mat-form-field>
          </div>
...
export class StudentDialogComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.studentForm = this.fb.group({
      ...
      Attendance: [{ value: '', disabled: isView }, [Validators.required, Validators.min(0), Validators.max(100)]],
      Monthly_Mark: [{ value: '', disabled: isView }, [Validators.required, Validators.min(0), Validators.max(100)]],
